        ...
        <form role="form" method="post">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="email" style="width: 600px" name="txtEmail" class="form-control" id="txtEmail" placeholder="Email" required>
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Password:</label>
              <input type="password" style="width: 600px" name="txtPassword" class="form-control" id="txtPassword" placeholder="Password" required>
            </div>
          </div>
          <!-- /.card-body -->
