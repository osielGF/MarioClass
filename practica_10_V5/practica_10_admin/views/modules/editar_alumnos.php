      ...
      <div class="card card-primary">
        ...
        <form role="form" method="post">
          <div class="card-body">
            ...
            <!-- Camos a usar para la funcion JavaScript -->  
              <label for="exampleInputEmail1">Carrera:</label>
              <select style="width: 300px" onchange="act();" id="select_carreras" name="select_carreras" class="form-control my-colorpicker1" required >
                <?php
            ...
            <div class="form-group">
              ...
              <select style="width: 300px" id="select_profesores" name="select_profesores" class="form-control my-colorpicker1" required>
                ...
                <?php
                  //cREAR un objeto MVC y accionar el controlador para traer todas las carreras y llenar el select
                  $opcionesProfes = new MvcController();
                  $resp = $opcionesProfes -> getProfesoresControllerJavaScript();
                ?>  
        ...
        <input type="hidden" name="alu" id="alu" value="<?php echo $resp ?>" style="width: 100%;">
        <!-- **************************************************** -->
...
<script type="text/javascript">
    ...
    function act()
    {
      $('#select_profesores').empty().trigger("change");
      var g = document.getElementById("select_carreras").value+"";
      ...
      for (var i = 0; i < v1.length-1; i++) 
      {
        ...
        if(f[2]===g)
        {
          document.getElementById("select_profesores").options[document.getElementById("select_profesores").options.length] = new Option(f[1], f[0]);
        }
      }
    }
</script>
