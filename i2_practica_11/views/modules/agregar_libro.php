        ...
        <form role="form" method="post">
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" style="width: 300px" name="txtTitulo" class="form-control" id="txtTitulo" placeholder="Titulo" required>
            </div>
            <div class="form-group">
          ...
          <div class="card-footer">
            <input style="background-color: #0E0043" title="Agregar" name="btnEnviar" type="submit" value="AGREGAR" class="btn btn-primary">
