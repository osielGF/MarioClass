          ...
          <div class="card">
            <div class="card-header">
              <div class="float-left">
                <a style="background-color: #31971A" href="index.php?action=agregar_libro" class="btn btn-success" title="Agregar carrera">
...
<script type="text/javascript">
  ...
  document.getElementById("n2").style.background='#53585A';
  }
</script>