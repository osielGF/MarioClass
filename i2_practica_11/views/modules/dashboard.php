        ...
        <div class="row" align="center">
          ...
          <div class="col-lg-6 col-8">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <?php 
                    $cantidad_libros = new MvcController();
                    $cantidad_libros -> getCantidadLibrosController();
                ?>
              ...
              <a href="?action=libros" class="small-box-footer">Más información <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
         </div>
        </div>
