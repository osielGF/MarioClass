...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-10-2018 a las 08:32:30
...
(22, '1430119', 'Jesus', 'Estrada', 'Silva', 1, 3),
(23, '1530272', 'Osiel', 'Gomes', 'Flores', 2, 0);
...
(5, 'Alberto', 'Garcia', 'Robledo', 6, 1),
(6, 'Marina', 'Flores', 'Flores', 7, 2),
(7, 'Fidencio', 'Martinez', 'S', 8, 1);
...
(10, 22, 3, 2, '2018-10-22', '23:50:32', 'Individual', ' ouiuiuiu'),
(11, 22, 3, 1, '2018-10-22', '23:52:52', 'Individual', ' lkj');
...
--
ALTER TABLE `sesion_tutoria`
  MODIFY `id_sesion_tutoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
