          ...
          <div class="card">
            <div class="card-header">
              <div class="float-left">
                ...
                <a href="index.php?action=agregar_profesores" class="btn btn-success" title="Agregar profesor">
            ...
            <div class="card-body">
                    ...
                    $vistaProfesores -> borrarProfesoresController();
      						?>
            </div>
            <!-- /.card-body -->
          </div>
...
<script type="text/javascript">
  ...
  document.getElementById("n5").style.background='#53585A';
  }
</script>