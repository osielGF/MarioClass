...
class Datos extends Conexion
{
	...
	public static function getAlumnosTutorModel($tabla,$idCarrera)
	{
 	...
 	public static function editarTipoProblemaModel($idProblema,$tabla)
 	{
 		$stm = Conexion::conectar()->prepare("SELECT * FROM $tabla WHERE id_tipo_problema = :id_tipo_problema");
 		$stm->bindParam(":id_tipo_problema", $idProblema);
 		$stm->execute();
 		return $stm->fetch();
 		$stm->close();
 	}
