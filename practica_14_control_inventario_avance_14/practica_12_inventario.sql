...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-06-2018 a las 12:37:04
...
(26, 50, 11, 199, '2018-06-14', 'porke si', '\'908765', 2, 'AUMENTÃ“ STOCK'),
(27, 50, 5, 1, '2018-06-18', 'jhkl', '9876', 2, 'DISMINUYÃ“ STOCK'),
(28, 50, 5, 20, '2018-06-18', 'jhkl', '98745', 2, 'AUMENTÃ“ STOCK'),
(29, 50, 5, 20, '2018-06-18', 'bjnkm', '8765', 2, 'AUMENTÃ“ STOCK');
...
(50, 'hielos el perico', 15, 18, 20, 'HIELOS frios', 2),
...
(3, '2018-06-14', 42, 'agua 2 litros', 3, 59, 2),
(4, '2018-06-14', 50, 'hielos el perico', 400, 18, 2),
(5, '2018-06-14', 50, 'hielos el perico', 99, 18, 2),
(6, '2018-06-14', 50, 'hielos el perico', 2, 36, 2),
(8, '2018-06-18', 50, 'hielos el perico', 99, 1782, 2),
(9, '2018-06-18', 50, 'hielos el perico', 20, 360, 2);
...
--
ALTER TABLE `historial`
  MODIFY `id_historial` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
